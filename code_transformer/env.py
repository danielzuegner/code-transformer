...
with env.prefixed("CODE_TRANSFORMER_"):
    ...
    POJ_DATA_PATH_STAGE_1 = env("POJ_DATA_PATH_STAGE_1", f"{_DATA_PATH}/poj_104/stage1")
    POJ_DATA_PATH_STAGE_2 = env("POJ_DATA_PATH_STAGE_2", f"{_DATA_PATH}/poj_104/stage2")
    CODEFORCES_DATA_PATH_STAGE_1 = env("CODEFORCES_DATA_PATH_STAGE_1", f"{_DATA_PATH}/codeforces/stage1")
    CODEFORCES_DATA_PATH_STAGE_2 = env("CODEFORCES_DATA_PATH_STAGE_2", f"{_DATA_PATH}/codeforces/stage2")
